		...
		<div class="ld-dashboard-course-content instructor-courses-list">
			<div class="ld-dashboard-section-head-title">
				...
				<div class="ld-dashboard-header-button ld-dashboard-add-new-button-container">
					...
					<span class="material-symbols-outlined add-icon"><?php esc_html_e( 'add', 'ld-dashboard' ); ?></span> <?php printf( esc_html__( 'Add A New %s', 'ld-dashboard' ), esc_html( LearnDash_Custom_Label::get_label( 'quiz' ) ) ); ?></a>
				</div>
			</div>
